...
(let [handler (handler/build3 handler* [{:wrap wrap1}
                                        {:wrap wrap2}
                                        #_{:wrap wrap2 :enter request2 :leave response2}
                                        {:enter request1 :leave response1}
                                        {:enter request2 :leave response2}
                                        {:wrap wrap3}
                                        {:wrap wrap4}])]
